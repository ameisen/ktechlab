...
{
	pressed = state;
	m_switch1->setState( state ? Switch::State::Open : Switch::State::Closed );
	m_switch2->setState( state ? Switch::State::Closed : Switch::State::Open );
	m_switch3->setState( state ? Switch::State::Open : Switch::State::Closed );
	m_switch4->setState( state ? Switch::State::Closed : Switch::State::Open );
}
//END class ECDPDT
...
{
	m_switch1->setState( state ? Switch::State::Closed : Switch::State::Open );
	m_switch2->setState( state ? Switch::State::Closed : Switch::State::Open );
	pressed = state;
}
//END class ECDPST
