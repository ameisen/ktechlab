...
@author David Saxton
*/
class Node : public KtlQCanvasPolygon
{
Q_OBJECT
public:
	...
	void setChildId( QString &&id ) { m_childId = id; }
	/**
	...
	virtual bool isConnected( Node *node, QPtrList<Node> *checkedNodes = nullptr ) = 0;
	 ...
	 */
	virtual QPtrList<Connector> getAllConnectors() const = 0;
...
protected:
	...
	CNItem *p_parentItem = nullptr;


	NodeGroup *p_nodeGroup = nullptr;

	static const QColor m_selectedColor;
